...
SYSTEM_PROMPT = (
    ...
    '5. Si hay varias consultas, haz un RECORRIDO CRONOLÓGICO de la evolución antes de '
    'la sección de impresión clínica.\n'
    '6. Usa lenguaje clínico apropiado pero evita frases como "el sistema diagnostica" o '
    '"el diagnóstico es". Usa en cambio: "los hallazgos son compatibles con", '
    '"se sugiere considerar", "el médico veterinario deberá valorar".\n'
    '7. Responde siempre en español. No inventes datos ausentes en la información. '
...
def build_prompt(req: DiagnosticoRequest) -> Tuple[str, str]:
    ...
    tareas = {
        'HC_solo': (
            ...
            '1. **Resumen del paciente** — especie, edad, sexo, peso; '
            'evolución cronológica de los motivos de consulta y signos registrados.\n'
        ...
        'HC_Hemograma': (
            'Redacta un reporte preliminar de apoyo con la siguiente estructura:\n'
            '1. **Resumen del paciente** — especie, edad, sexo, peso; '
            'evolución cronológica de los signos clínicos registrados.\n'
            ...
            '6. **Nivel de confianza y limitaciones** del análisis\n'
            f'7. {AVISO}'
        ),
        'HC_Radiografia': (
            'Redacta un reporte preliminar de apoyo con la siguiente estructura:\n'
            '1. **Resumen del paciente** — especie, edad, sexo, peso; '
            'evolución cronológica de los signos clínicos.\n'
            '2. **Interpretación de predicciones CNN** — convierte cada predicción del modelo '
            'en lenguaje clínico; indica el nivel de confianza y si el hallazgo supera o no '
            'el umbral diagnóstico; relaciona con el perfil del paciente.\n'
            '3. **Limitaciones del análisis radiológico** — menciona las reportadas por el CNN '
            'y cualquier otra consideración relevante.\n'
            '4. **Impresión clínica orientativa** — hallazgos compatibles con, ordenados '
        ...
        'HC_Hemograma_Radiografia': (
            'Redacta un reporte preliminar de apoyo integrado con la siguiente estructura:\n'
            '1. **Resumen del paciente** — especie, edad, sexo, peso; '
            'evolución cronológica de los signos clínicos registrados.\n'
            '2. **Interpretación de predicciones CNN** — convierte cada predicción en lenguaje '
            'clínico con su nivel de confianza; menciona las limitaciones del modelo.\n'
            ...
            '4. **Correlación clínica integrada** — integra los datos de imagen CNN, '
            'laboratorio e historia clínica para construir la impresión orientativa.\n'
            ...
            '8. **Nivel de confianza y limitaciones** del análisis integrado\n'
            f'9. {AVISO}'
        ),
    }
