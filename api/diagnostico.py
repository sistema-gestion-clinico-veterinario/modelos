...
def build_prompt(req: DiagnosticoRequest) -> Tuple[str, str]:
    ...
    tareas = {
        ...
        'HC_Radiografia': (
            ...
            '2. **Hallazgos radiológicos** — describe en lenguaje clínico veterinario cada '
            'hallazgo identificado en las radiografías procesadas. NO menciones nombres de '
            'modelos de IA ni valores numéricos de probabilidad; usa términos como '
            '"se identifican hallazgos compatibles con", "no se observan alteraciones '
            'significativas en", "los hallazgos sugieren". Relaciona cada hallazgo con el '
            'perfil del paciente (especie, edad, peso).\n'
            '3. **Limitaciones del estudio** — menciona las limitaciones clínicas relevantes '
            '(número de proyecciones, región anatómica, calidad) en lenguaje clínico, '
            'sin referencias técnicas a modelos de IA.\n'
        ...
        'HC_Hemograma_Radiografia': (
            ...
            'evolución cronológica de los signos clínicos registrados.\n'
            '2. **Hallazgos radiológicos** — describe en lenguaje clínico veterinario cada '
            'hallazgo de las radiografías. NO menciones nombres de modelos de IA ni valores '
            'de probabilidad numérica. Usa términos radiológicos clínicos estándar.\n'
            ...
            'laboratorio e historia clínica en lenguaje clínico veterinario.\n'
